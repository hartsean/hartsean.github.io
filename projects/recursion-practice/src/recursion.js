...
var exponent = function(base, exp) {
  //if number is 0 return 1 and if exp isone return base. 
   if (exp === 0) {
    return 1;
    }else if (exp < 0) {
...
//if character has a space
// iterate through the string starting from both sides. 
...
// inputs a string
//outputs a string with number as words. 

var numToText = function(str) {
  //chek if each index of each string character is a type of number
  //if it it, slice it out and assign it to variable.
/*
    let a = ['','one ','two ','three ','four ', 'five ','six ','seven ','eight ','nine ','ten ','eleven ','twelve ','thirteen ','fourteen ','fifteen ','sixteen ','seventeen ','eighteen ','nineteen '];
    if(str == a[1]){
       str.replace(str, a[1]);
      //add one to the index of a and call recursivly
      return numToText(str + a[str +1]);
    }else if (str == a[2]){
      return str.replace(str/*maybe a toString()method here*///, a[2]);
    //}//....etc
    //return str;
