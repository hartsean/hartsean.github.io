...
*/
     "I am a string" // This is what a string looks like, Can also be used with ''.
/*     
...
*/
     console.log(isNaN('hello world'));        // prints true to console because isNAN checks to see if the input is NaN and returns a boolean)
/*
